...
// Alternative user endpoint patterns to try (for admin users)
const USER_ENDPOINTS = [
  `${API_URL}/admin/profile`,  // Admin profile endpoint
  `${API_URL}/users/profile`,  // Regular user profile endpoint
  `${API_URL}/user`,
  `${API_URL}/auth/user`,
  `${API_URL}/auth/me`,
  `${API_URL}/users/me`,
    ...
    for (const endpoint of USER_ENDPOINTS) {
      try {
        ...
        if (response.data?.data?.user) {
          return { ...response, data: response.data.data.user };
        }
